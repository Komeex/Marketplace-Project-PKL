...
@section('content')
    ...
    {{-- product sec --}}
    <section class=" mt-24 px-[38px] md:px-[68px]">
        <h2 class="text-3xl sm:text-[36px] font-bold mb-6 leading-tight">
            Produk terbaru
        </h2>
    ...
    {{-- contact sec --}}
    <div id="contact"></div>
<div  class="flex flex-col lg:flex-row justify-between items-center lg:items-start mt-12 lg:mt-28 px-4 sm:px-8 md:px-16 lg;px-[68px] xl:px-[120px] gap-8 lg:gap-16">

    <div class="flex flex-col w-full lg:w-fit">
        <div class="flex flex-col text-start lg:text-left gap-4">
            <h2 class="font-lato text-3xl sm:text-4xl lg:text-[48px] font-medium text-gray-900 leading-tight">Hubungi Kami</h2>
            <p class="font-lato text-base sm:text-lg max-w-full lg:max-w-[651px] mt-2 text-gray-700">
                Punya pertanyaan tentang layanan kami atau butuh <span class="font-semibold"> estimasi gratis </span>untuk kebutuhan Anda? Jangan ragu hubungi kami! Kami sangat senang bisa membantu Anda menemukan solusi terbaik.
            </p>
        </div>

        <div class="mt-8 lg:mt-20 space-y-6">
            <div class="flex items-center gap-4 justify-start lg:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6 sm:size-7 text-blue-800">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                </svg>
                <p class="text-lg sm:text-xl font-semibold text-gray-800">085-792-307-417</p>
            </div>

            <div class="flex items-center gap-4 justify-start lg:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 sm:size-7 text-blue-800">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
                <p class="text-lg sm:text-xl font-semibold text-gray-800">Contact@gmail.com</p>
            </div>

            <div class="flex items-start gap-4 justify-start lg:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 sm:size-7 text-blue-800 mt-0.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                </svg>
                <p class="text-md sm:text-xl font-semibold max-w-xs sm:max-w-md lg:max-w-[514px] text-gray-800 text-start lg:text-left">
            ...
            <div class="flex items-center gap-4 justify-start lg:justify-start">
                ...
                <p class="text-lg sm:text-xl font-semibold max-w-[176px] text-gray-800">Senin - Jumat: 09.00 - 18.00 WITA</p>
            </div>
        </div>
    </div>

    <div class="relative flex-shrink-0 mt-8 lg:mt-0 w-full max-w-lg xl:max-w-[598px]">
        <img class="xl:w-full xl:h-auto lg:w-[503px] lg:h-[544.53px]  rounded-lg" src="img/contact-img.png" alt="Ilustrasi kontak kami">
    </div>
</div>
