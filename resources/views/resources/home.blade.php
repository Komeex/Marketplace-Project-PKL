...
@section('content')
    ...
    <section id="hero container" class="relative lg:pt-4 md:pt- sm:pt-12 px-[38px] sm:px-[68px] flex ">
        ...
        <div id class="flex lg:flex-row flex-col justify-center lg:justify-between items-center w-full h-screen">
            <div>
                ...
                <p
                    class="text-gray-300 font-lato lg:max-w-[302px] xl:max-w-[462px] text-[18px] sm:text-[20px]">
    ...
    {{-- slider --}}
    <div id="carousel"></div>
    <section class="relative px-[38px] md:px-[68px] overflow-x-hidden mt-48">
        <h2 class="text-3xl sm:text-[36px] font-bold mb-6 leading-tight">
            Produk Populer
        </h2>
            <button id="scrollLeftBtn" class="absolute left-3 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-black/70 hover:bg-black/90 rounded-lg text-white transition-all duration-300 flex items-center justify-center hover:-translate-x-1 z-10">
        ...
        <button id="scrollRightBtn" class="absolute right-3 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-black/70 hover:bg-black/90 rounded-lg text-white transition-all duration-300 flex items-center justify-center hover:translate-x-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex items-center justify-center pt-12 overflow-x-hidden">
        <a href="/produk" class="font-lato text-lg font-medium px-72 p-1 border-2 transform hover:scale-105 hover:text-[#ffffff] hover:bg-[#1E3A8A] ease-in-out duration-300">Lihat Lebih Banyak</a>
    </div>
