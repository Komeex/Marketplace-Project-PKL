            ...
            <div class="flex flex-row gap-2 lg:gap-4">
                <div class="flex flex-col gap-2 lg:gap-4">
                    <img class="gambar-popup cursor-pointer w-[127px] h-[127px] sm:w-[183px] sm:h-[183px] md:w-[234px] md:h-[234px] lg:w-[242px] lg:h-[242px] xl:w-[270px] xl:h-[270px] object-cover transform hover:scale-105 transition-all duration-300 ease-in-out"
                        src="img/produk/Celana/celana-vcrl2.png" alt="">
                    <img class="gambar-popup cursor-pointer w-[127px] h-[127px] sm:w-[183px] sm:h-[183px] md:w-[234px] md:h-[234px] lg:w-[242px] lg:h-[242px] xl:w-[270px] xl:h-[270px] object-cover transform hover:scale-105 transition-all duration-300 ease-in-out"
                        src="img/produk/Celana/celana-vcrl1.png" alt="">
                </div>
                <div>
                    <img class="gambar-popup cursor-pointer w-[167px] h-[259px] sm:w-[234px] sm:h-[371px] md:w-[278px] md:h-[470px] lg:w-[286px] lg:h-[501px] xl:w-[350px] xl:h-[553px] object-cover transform hover:scale-105 transition-all duration-300 ease-in-out"
                        src="img/produk/Celana/celana-vcrl.png" alt="">
                </div>
            </div>
            ...
            <div class="flex flex-col justify-between px-[68px] overflow-hidden">
                <div class="flex flex-col gap-2">
                    <h1
                        ...
                        Celana Jeans Panjang Pria Korean Stlye Straight Loose Pants Pria </h1>
                    <div class="text-lato flex items-center space-x-2 ">
                        <span class="text-[20px] sm:text-[24px] font-medium text-gray-900">Rp 137.500</span>
                        <span class="text-sm sm:text-base text-gray-500 line-through">Rp 150.000</span>
                    </div>
                    <p class="text-sm sm:text-[17px] max-w-[431px]">
                        ✔ Bebas Gerak Seharian – Cutting loose fit & straight, dijamin nyaman tanpa ketat. <br>
                        ✔ Bahan Premium Adem – Anti gerah & gatal, tetap stylish! <br>
                        ✔ Gak Mudah Melar – Bentuk tetap keren walau aktif seharian. <br>
                        ✔ Cocok Buat Semua Gaya – Casual atau streetwear? Auto cocok!

                        ⚠️ Stok terbatas! Tanyakan dulu sebelum order ya, brody
                    </p>
                        ...
                        <div class="flex items-center justify-between w-full">
                            ...
                            <div class="relative inline-block w-48">
                                <select name="size" id="size-selector"
                                    ...
                                    <option value="s">Sandwash blue</option>
                                    <option value="s">Hitam</option>
                                </select>
                                <div
                                    class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                    <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg"
