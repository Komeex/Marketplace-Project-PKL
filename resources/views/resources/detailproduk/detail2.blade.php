...
@section('content')
   ...
   <div class="w-full h-auto mb-48 sm:px-[68px] overflow-hidden">
    <div class="flex flex-col lg:flex-row items-center justify-center gap-16 mt-12 lg:mt-36 -full">
        <div class="flex flex-row gap-2 lg:gap-4">
            <div class="flex flex-col gap-2 lg:gap-4">
                <img class="gambar-popup cursor-pointer w-[127px] h-[127px] sm:w-[183px] sm:h-[183px] md:w-[234px] md:h-[234px] lg:w-[242px] lg:h-[242px] xl:w-[270px] xl:h-[270px] object-cover transform hover:scale-105 transition-all duration-300 ease-in-out"
                    src="img/produk/Spatu/spatu1.png" alt="">
                <img class="gambar-popup cursor-pointer w-[127px] h-[127px] sm:w-[183px] sm:h-[183px] md:w-[234px] md:h-[234px] lg:w-[242px] lg:h-[242px] xl:w-[270px] xl:h-[270px] object-cover transform hover:scale-105 transition-all duration-300 ease-in-out"
                    src="img/produk/Spatu/spatu2.png.png" alt="">
            </div>
            <div>
                <img class="gambar-popup cursor-pointer w-[167px] h-[259px] sm:w-[234px] sm:h-[371px] md:w-[278px] md:h-[470px] lg:w-[286px] lg:h-[501px] xl:w-[350px] xl:h-[553px] object-cover transform hover:scale-105 transition-all duration-300 ease-in-out"
                    src="img/produk/Spatu/spatu.png" alt="">
            </div>
        </div>
        ...
        <div class="flex flex-col justify-between px-[68px] overflow-hidden">
            <div class="flex flex-col gap-2">
                <h1 class="font-lato text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold max-w-[501px] leading-tight">SABA Veloz Grey White - Sepatu Sneakers
                    Casual Pria Wanita </h1>
                <div class="text-lato flex items-center space-x-2 ">
                    <span class="text-[20px] sm:text-[24px] font-medium text-gray-900">Rp122.500</span>
                    <span class="text-sm sm:text-base text-gray-500 line-through">Rp 179.200</span>
                </div>
                <p class="text-sm sm:text-[17px] max-w-[431px]">
                    Dapatkan produk SABA yang berkualitas, up to date model terbaru, terjangkau serta banyak pilihan
                    harga & model.
                    Serta kami mengutamakan kenyamanan & pelayanan belanja, silahkan bebas bertanya tanya dulu sebelum
                    melakukan transaksi
                </p>
                <div class="flex flex-col gap-4 mt-2 max-w-[351px]">
                    <div class="flex items-center justify-between w-full">
                        <h4 class="text-base sm:text-[17px] font-semibold">Kategori</h4>
                        <div class="w-48 text-base sm:text-[17px]">
                            Baju
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div class="relative inline-block w-48">
                            <select name="size" id="size-selector"
                                ...
                                <option value="s">Grey White</option>
                                </select>
                            <div
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div class="w-48 ">
                            <div class="text-lato flex items-center space-x-2 ">
                                <span class="text-base sm:text-[17px] font-medium text-gray-900">Rp 89.000</span>
            ...
            <div class="flex gap-4 mt-6"> <div class="w-[180px] h-[45px] sm:w-[210px] sm:h-[50px] bg-[#006FFF] rounded-[10px] items-center justify-center flex ">
                    <button class="text-base sm:text-[18px] font-bold text-white">Tambah ke keranjang</button>
                </div>
                <div class="w-[150px] h-[45px] sm:w-[170px] sm:h-[50px] bg-[#949494] rounded-[10px] items-center justify-center flex ">
    ...
    <div id="overlaygambar" class="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center hidden z-50 overflow-hidden">
        <div class="relative">
